...
class PagerTab extends StatefulWidget {
  ...
  @override
  _PagerTabState createState() => new _PagerTabState(
      type,
      tabItems,
      tabViews,
      backgroundColor,
...
class _PagerTabState extends State<PagerTab>
  ...
  Widget build(BuildContext context) {
    ///顶部TAbBar模式
    if (this._type == PagerTab.TOP_TAB) {
      return new Scaffold(
